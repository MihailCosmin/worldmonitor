...
export const COMMANDS: Command[] = [
  ...
  { id: 'panel:stock-analysis', keywords: ['stock analysis', 'equity analysis', 'earnings signals'], label: 'Panel: Stock Analysis', icon: '\u{1F4C8}', category: 'panels' },
  { id: 'panel:stock-backtest', keywords: ['backtest', 'stock backtest', 'backtesting', 'strategy'], label: 'Panel: Backtesting', icon: '\u{1F4C9}', category: 'panels' },
