...
export const INTEL_SOURCES: Feed[] = [
  ...
  // Declared LAST in the defense group on purpose so the earlier entries
  // remain the editorial defaults anywhere consumers preserve declaration
  // order. Adding a new source here should not reshuffle the established
  // ordering of the existing default defense lineup.
