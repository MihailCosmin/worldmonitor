  ...
  "plans": [
    {
      ...
      "selfServe": false,
      "description": "Full live map — all 56 layers, 500+ feeds, Stock analysis, backtesting & daily AI market briefs, WM Analyst chat across 30+ live services, Country briefs, instability index & resilience scores"
    },
    {
      "planKey": "pro_monthly",
      "name": "Pro Monthly",
    ...
    },
    {
      ...
      "currentForCheckout": true,
      "selfServe": true,
      "description": "Everything in Pro, Use for client work, internal tools & reporting, Data export — CSV, JSON & PDF reports, MCP + SDK: 250 calls/day (vs 50), Priority support, Commercial license included"
    },
    {
...
export const TIER_CONFIG = {
  "free": {
    ...
    "features": [
      "Full live map — all 56 layers, 500+ feeds",
      "Stock analysis, backtesting & daily AI market briefs",
      "WM Analyst chat across 30+ live services",
      "Country briefs, instability index & resilience scores"
    ],
    "planLimits": {
      "apiRequestsPerDay": 0,
  ...
  "pro": {
    ...
    "features": [
      "Everything in Free",
      "Personal AI digest & real-time alerts — Slack, Discord, Telegram, Email, webhook",
      "Custom alert rules — quiet hours, AES-256 encrypted channels",
      "MCP + SDK access for Claude Desktop & other AI clients (50 calls/day)",
      "Priority data refresh — near real-time",
      "Pro Widget Builder — smarter model, more turns, interactive JS"
    ],
    "highlightFeatures": [
      "Personal license"
    ],
