...
never promotes a lower-severity story above a higher-severity one. If the
followed-country relay is unavailable, the brief falls back to the unbiased
ordering rather than treating the missing list as ground truth.
