...
The Supply Chain panel itself is **free** on web (full / finance / commodity variants). On desktop, the full-variant registration layers `premium: 'enhanced'`. Scenario Engine activation is available to free users on web and desktop.
