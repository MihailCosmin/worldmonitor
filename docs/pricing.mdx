---
title: "Plans & Pricing"
description: "Free, Pro, API Starter, API Business, and Enterprise plans — prices, what each includes, and the machine-readable pricing surfaces for agents."
---
...
| **Pro** | $39.99/month · $399.99/year | Scheduled AI digests, custom alert rules, MCP access, priority data refresh, Pro Widget Builder |
