...
describe('buildSummaryCacheKey', () => {
  ...
  it('systemAppend suffix does not break existing namespace', () => {
    ...
    // v8 → v9 on 2026-08-01 (#5969 prompt/cache selection parity) and, on this
    // fork, the 2026-07-29 Ollama-priority fix; v7 → v8 on 2026-07-06 (#4944
    // DeepSeek cutover); v6 → v7 on 2026-07-05 (#4914 pair-dedup); v5 → v6 on
    // 2026-04-24 (RSS grounding fix, U6).
